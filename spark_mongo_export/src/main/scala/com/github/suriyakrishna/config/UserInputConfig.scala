...
class UserInputConfig private(args: Array[String], className: String) {
  ...
  private def getAppOptions: Options = {
    ...
    val schemaPath: Option = new Option("sPath", "schemaPath", true, "Input Data File Schema Path. Schema will be inferred from file by default. Spark Struct JSON Schema Specification")
